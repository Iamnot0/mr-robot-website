...
import { Accessibility as AccessibilityIcon, Eye, MousePointer, Volume2, Keyboard, Monitor, Heart } from 'lucide-react';
      ...
      <div className="bg-primary py-16">
        <div className="container mx-auto px-6 text-center">
          <div className="flex justify-center mb-6">
            <AccessibilityIcon className="h-16 w-16 text-primary-foreground" />
          </div>
